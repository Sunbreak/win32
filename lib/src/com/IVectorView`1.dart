...
typedef _IndexOf_Native = Int32 Function(Pointer obj, Pointer value,
    Pointer<Uint32> index, Pointer< /* Boolean */ Uint8> result);
typedef _IndexOf_Dart = int Function(Pointer obj, Pointer value,
    Pointer<Uint32> index, Pointer< /* Boolean */ Uint8> result);

typedef _GetMany_Native = Int32 Function(Pointer obj, Uint32 startIndex,
    Pointer<Pointer> items, Pointer<Uint32> result);
typedef _GetMany_Dart = int Function(Pointer obj, int startIndex,
    Pointer<Pointer> items, Pointer<Uint32> result);
...
class IVectorView<T> {
  ...
  int IndexOf(Pointer value, Pointer<Uint32> index,
  ...
  int GetMany(int startIndex, Pointer<Pointer> items, Pointer<Uint32> result) =>
      ptr.ref.lpVtbl.value
              .elementAt(9)
              .cast<Pointer<NativeFunction<_GetMany_Native>>>()
              .value
              .asFunction<_GetMany_Dart>()(
          ptr.ref.lpVtbl, startIndex, items, result);
}
